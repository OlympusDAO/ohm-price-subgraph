...
export function createLogMonetaryPolicyUpdatedEvent(
  monetaryPolicy: Address
): LogMonetaryPolicyUpdated {
  let logMonetaryPolicyUpdatedEvent = changetype<LogMonetaryPolicyUpdated>(
    newMockEvent()
  )

  logMonetaryPolicyUpdatedEvent.parameters = new Array()

  logMonetaryPolicyUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "monetaryPolicy",
      ethereum.Value.fromAddress(monetaryPolicy)
    )
  )

  return logMonetaryPolicyUpdatedEvent
}
